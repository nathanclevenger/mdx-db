...
describe('FetchCollection', () => {
    ...
    beforeEach(() => {
        mockFetch.mockReset();
        collection = new FetchCollection('https://example.com/test', 'https://example.com/api/test', { apiKey: 'test-key' });
    });
    test('gets document', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/test-id'), expect.objectContaining({
